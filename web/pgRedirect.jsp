...
parameters.put("MOBILE_NO","7389705899");
parameters.put("EMAIL","mahimauikey9@gmail.com");
parameters.put("CALLBACK_URL", "http://localhost:8080/FoodOrderingSystem/pgResponse.jsp");
