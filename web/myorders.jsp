<%-- 
    Document   : myorders
    Created on : 3 May, 2020, 2:50:05 PM
    Author     : HP
--%>
...
<html>
    ...
    <body>
                ...
                <div id="loginbox" style="margin-top: 50px;"
                    ...
                    <div class="panel panel-info">
                        ...
                        <div style="padding-top: 30px" class="panel-body">
                            ...
                            <!-- Address Form -->
                            <form action="${pageContext.request.contextPath}/CancelOrderServlet?cancelid=${myorder.orderid}" method="POST" class="form-horizontal">
                                ...
                                <div  >						
                                    ...
                                    <input type="submit" class="btn btn-success" value="cancel Order" name="cancelorder"/>
        ...
        <div id="fh5co-menus" data-section="menu">
         ...
         <a href="${pageContext.servletContext.contextPath}/paytm.jsp?totalcost=${myorder.totalcost}">PROCEED TO PAYMENT</a>
