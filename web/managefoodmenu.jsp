<%-- 
    Document   : managefoodmenu
    Created on : 3 May, 2020, 2:48:14 PM
    Author     : HP
--%>
                    ...
                    <div class="col-md-6">
                        <div class="fh5co-food-menu to-animate-2">
                            <c:forEach items="${foodlist}"  var="current" begin="0" end="${(fn:length(foodlist)-1)/2}">
                               ...
                               <table >
                                            <tr>
                                                <td>  <a href="${pageContext.servletContext.contextPath }/GetMenutoUpdateServlet?food_id=${current.fooditemid}">Edit</a></td>
                                                <td><a href="${pageContext.servletContext.contextPath }/RemoveItemServlet?food_id=${current.fooditemid}">Remove</a></td></tr>
                                        </table>
                            </c:forEach>
                        </div>
                    </div>
